...
export default function Show(){
    ...
    function saveEdit() {
        axios.put("https://jfsd-spring-hosting-production-0e4c.up.railway.app/update", {
    ...
    if(result == null) {
        axios.get("https://jfsd-spring-hosting-production-0e4c.up.railway.app/all", {}).then ((res)=>{
            setResult(res.data)
        })
    }
